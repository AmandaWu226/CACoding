...
public class SignupUseCaseFactory {
    ...
    private static ClearController createClearController(ViewManagerModel viewManagerModel, ClearViewModel clearViewModel, ClearUserDataAccessInterface clearUserDataAccessObject) {
        ClearOutputBoundary clearOutputBoundary = new ClearPresenter(viewManagerModel, clearViewModel);

        ClearInputBoundary clearUsersInteractor = new ClearInteractor(clearUserDataAccessObject, clearOutputBoundary);
        return new ClearController(clearUsersInteractor, clearUserDataAccessObject);
    }
